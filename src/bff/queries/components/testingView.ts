...
export const testingViewQuery = gql`
  query View(
    $urn: URN!
    ...
    $numberOfCardsInAllCompetitionsView: Int!
    $numberOfCardsInAllMarketsView: Int!
    $numberOfCardsInCompetitionView: Int!
    $numberOfCardsInEventView: Int!
    $numberOfCardsInGamingCategoryView: Int!
    $numberOfCardsInGamingSegmentationView: Int!
    $numberOfCardsInGamingView: Int!
    $numberOfCardsInGenericView: Int!
    $numberOfCardsInImsPromotionView: Int!
    $numberOfCardsInNotFoundView: Int!
    $numberOfCardsInPromotionsView: Int!
    $numberOfCardsInRaceView: Int!
    $numberOfCardsInSportView: Int!
  ...
  fragment allCompetitionsView on AllCompetitionsView {
    ...
    url
    title
    items(first: $numberOfCardsInAllCompetitionsView) {
      ...viewItems
      __typename
    }
    partialItems: items {
  ...
  fragment allMarketsView on AllMarketsView {
    ...
    url
    title
    items(first: $numberOfCardsInAllMarketsView) {
      ...viewItems
      __typename
    }
    partialItems: items {
  ...
  fragment competitionView on CompetitionView {
    ...
    items(first: $numberOfCardsInCompetitionView) {
      ...viewItems
      __typename
    }
    partialItems: items {
  ...
  fragment eventView on EventView {
    ...
    urn
    url
    items(first: $numberOfCardsInEventView) {
      ...viewItems
      __typename
    }
    canonicalUrl
  ...
  fragment gamingCategoryView on GamingCategoryView {
    ...
    urn
    url
    items(first: $numberOfCardsInGamingCategoryView) {
      ...viewItems
      __typename
    }
    partialItems: items(first: 100) {
  ...
  fragment gamingSegmentationView on GamingSegmentationView {
    ...
    urn
    url
    items(first: $numberOfCardsInGamingSegmentationView) {
      ...viewItems
      __typename
    }
    partialItems: items(first: 100) {
  ...
  fragment gamingView on GamingView {
    ...
    urn
    url
    items(first: $numberOfCardsInGamingView) {
      ...viewItems
      __typename
    }
    partialItems: items {
  ...
  fragment genericView on GenericView {
    ...
    items(first: $numberOfCardsInGenericView) {
      ...viewItems
      __typename
    }
    partialItems: items {
  ...
  fragment imsPromotionView on ImsPromotionView {
    ...
    url
    title
    items(first: $numberOfCardsInImsPromotionView) {
      ...viewItems
      __typename
    }
    partialItems: items {
  ...
  fragment notFoundView on NotFoundView {
    ...
    urn
    url
    items(first: $numberOfCardsInNotFoundView) {
      ...viewItems
      __typename
    }
    bottomBar @include(if: $withBottomBar) {
  ...
  fragment promotionsView on PromotionsView {
    ...
    urn
    url
    items(first: $numberOfCardsInPromotionsView) {
      ...viewItems
      __typename
    }
    partialItems: items {
  ...
  fragment raceView on RaceView {
    ...
    items(first: $numberOfCardsInRaceView) {
      ...viewItems
      __typename
    }
    partialItems: items {
  ...
  fragment sportView on SportView {
    ...
    items(first: $numberOfCardsInSportView) {
      ...viewItems
      __typename
    }
    partialItems: items {
